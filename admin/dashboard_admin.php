...
<div class="flex min-h-screen">
    ...
    <aside class="w-60 bg-white border-r border-slate-200 flex-col p-5 shrink-0 hidden md:flex">
        ...
        <div class="border-t border-slate-200 pt-3 mt-2">
            <a href="../user/logout.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-500 text-sm font-medium transition-colors hover:bg-red-50 hover:text-red-600">
                <?= icon('logout', 18) ?>
                <span>Keluar</span>
            </a>
        </div>
